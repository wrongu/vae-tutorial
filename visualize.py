...
def render_grid(sample_var, reconstruction_var, ndim=2, preset_vars=[], preset_values=[], img_rows=28, img_cols=28, img_channels=1, display=True):
    ...
    renderer = K.function([sample_var] + preset_vars, [reconstruction_var])
    ...
    for i in range(num_grid):
        for j in range(num_grid):
            ...
            img = renderer([latent_input] + preset_values)[0]
